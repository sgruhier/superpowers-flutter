...
**Context:** If working in an isolated worktree, it should have been created via the `superpowers-flutter:using-git-worktrees` skill at execution time.
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers-flutter:subagent-driven-development (recommended) or superpowers-flutter:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use superpowers-flutter:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use superpowers-flutter:executing-plans
